...
namespace NatsuLang::Expression
{
	...
	{
	public:
		ConstructExpr(Type::TypePtr type, SourceLocation loc, NatsuLib::natRefPointer<Declaration::ConstructorDecl> constructorDecl, NatsuLib::Linq<NatsuLib::Valued<ExprPtr>> const& args)
